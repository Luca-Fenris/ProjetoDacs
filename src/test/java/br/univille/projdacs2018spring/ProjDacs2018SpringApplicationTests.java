...
public class ProjDacs2018SpringApplicationTests {
	...
	public void pacienteControllerSaveTest() throws Exception {
		this.mockMvc
				.perform(post("/paciente").contentType(MediaType.APPLICATION_FORM_URLENCODED).param("form", "")
						.content("id=0&nome=zezinho&sexo=Masculino"))
				.andDo(print()).andExpect(status().isMovedTemporarily()).andExpect(view().name("redirect:/paciente"));
